...
class PacmanGame:
    ...
    def init_field(self):
        ...
        self.field = GameField(self.screen, DATA['map_file'], curses.color_pair(4), curses.color_pair(1))
    ...
    def collision(self):
        for ghost in self.ghosts.values():
            if (ghost.y, ghost.x) in [(self.pacman.y, self.pacman.x), (self.pacman.prev_y, self.pacman.prev_x)]:
                return True
        return False
            ...
            for i, line in enumerate(lines):
                try:
                    if 7 <= i <= 15:
                        ...
                        self.field.mapa.addstr(i, 0, line.rstrip(), curses.color_pair(4))
                except curses.error:
                    pass
